...
public class BattleMenuScript3 : MonoBehaviour {
	...
	public AudioClip go;
	static public int monsterHP3 = 6000; //change
	static public  int playerHP3 = 2000;//change
	...
	void OnGUI() {
		...
		hpstring = "HP: " + playerHP3 + "/2000";//change
		string enstring = "HP: " +monsterHP3+"/6000";//change
		...
		if (hit == true){
			hcnenemy.saltidle = false;//change
			hcnenemy.saltattack = true;
			Playerscript3.playeridle3 = false;
			Playerscript3.playerhit3 = true;
			hit = false;
		}
		if (attacking == true){
			Playerscript3.playeridle3 = false; //change
			Playerscript3.playerattack3 = true;
			hcnenemy.saltidle = false;
			hcnenemy.salthit = true;
			attacking = false;
