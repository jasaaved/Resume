...
public class BattleMenuScript4 : MonoBehaviour {
	...
	void OnGUI() {
		...
		if (hit == true){
			oxygenenemy.saltidle = false;//change
			oxygenenemy.saltattack = true;
			Playerscript4.playeridle3 = false;
			Playerscript4.playerhit3 = true;
			hit = false;
		}
		if (attacking == true){
			Playerscript4.playeridle3 = false; //change
			Playerscript4.playerattack3 = true;
			oxygenenemy.saltidle = false;
			oxygenenemy.salthit = true;
			attacking = false;
