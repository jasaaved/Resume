...
public class BattleMenuScript5 : MonoBehaviour {
	...
	void OnGUI() {
		...
		if (hit == true){
			wenemy.saltidle = false;//change
			wenemy.saltattack = true;
			Playerscript5.playeridle3 = false;
			Playerscript5.playerhit3 = true;
			hit = false;
		}
		if (attacking == true){
			Playerscript5.playeridle3 = false; //change
			Playerscript5.playerattack3 = true;
			wenemy.saltidle = false;
			wenemy.salthit = true;
			attacking = false;
