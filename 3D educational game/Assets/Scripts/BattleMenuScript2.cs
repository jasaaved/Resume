...
public class BattleMenuScript2 : MonoBehaviour {
	...
	void OnGUI() {
		...
		if (hit == true){
			coenemy.saltidle = false;//change
			coenemy.saltattack = true;
			Playerscript2.playeridle3 = false;
			Playerscript2.playerhit3 = true;
			hit = false;
		}
		if (attacking == true){
			Playerscript2.playeridle3 = false; //change
			Playerscript2.playerattack3 = true;
			coenemy.saltidle = false;
			coenemy.salthit = true;
			attacking = false;
